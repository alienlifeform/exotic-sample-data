...
display(HTML('<p>In this step, you will be presented with the first of your telescope images and a star chart with your target star in the center.</p><hr>'));

display(HTML('<table border=0 cellpadding=4><tr><td valign=top>The <b>left image</b> will be interactive, you will rollover the stars you find to see their coordinates, which you will then enter into a text field. <ul class="step"><li class="step4">Stargazer Tip: Notice the cluster of 3-4 stars running from right-of-center up towards the top right.</li><li class="step4">Stargazer Tip: Notice the three larger stars running from the top left to the middle right</li></ul></td><td valign=top>The <b>right image</b> is the AAVSO star chart, with the target star represented as a crosshair instead of a black dot. <ul class="step"><li class="step4">The "target star" is in the center, represented by a crosshair</li><li class="step4">The "comparison stars" have small numbers next to them. They have a known, stable brightness to use as a baseline.</li></ul></td></tr><tr><td><img src="https://exoplanets.nasa.gov/system/exotic/exotic-telescope-image-tips.gif" height=400></td><td><img src="https://exoplanets.nasa.gov/system/exotic/exotic-star-chart-tips.gif" height=400></td></tr></table>'))
